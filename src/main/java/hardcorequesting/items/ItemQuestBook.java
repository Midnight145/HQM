...
public class ItemQuestBook extends Item {
	...
	@Override
	@SideOnly(Side.CLIENT)
	public IIcon getIconFromDamage(int dmg) { return dmg == 1 ? opIcon : itemIcon; }
	...
	@Override
	public boolean hasEffect(ItemStack itemStack, int pass) { return itemStack.getItemDamage() == 1; }
