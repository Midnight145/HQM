...
public class MinecraftAdapter {
	public static final TypeAdapter<ItemStack> ITEM_STACK = new TypeAdapter<ItemStack>() {
		...
		private Item getItemFromID(String mod, String name) {
			Block block;
			Item item;
			if ((item = GameRegistry.findItem(mod, name)) != null)
				return item;
			else if ((block = GameRegistry.findBlock(mod, name)) != null)
	...
	public static final TypeAdapter<NBTTagCompound> NBT_TAG_COMPOUND = new TypeAdapter<NBTTagCompound>() {
		@Override
		public void write(JsonWriter out, NBTTagCompound value) throws IOException { out.value(value.toString()); }
	...
	public static final TypeAdapter<Fluid> FLUID = new TypeAdapter<Fluid>() {
		@Override
		public void write(JsonWriter out, Fluid value) throws IOException { out.value(value.getName()); }

		@Override
		public Fluid read(JsonReader in) throws IOException { return FluidRegistry.getFluid(in.nextString()); }
	};
}
