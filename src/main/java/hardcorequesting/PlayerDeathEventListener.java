...
public class PlayerDeathEventListener {
	...
	public PlayerDeathEventListener() { MinecraftForge.EVENT_BUS.register(this); }
	...
	public void onPlayerRespawn(PlayerEvent.Clone event) {
		if (event.entityPlayer == null || event.entityPlayer instanceof FakePlayer || !event.wasDeath
				|| event.isCanceled()
				|| event.entityPlayer.worldObj.getGameRules().getGameRuleBooleanValue("keepInventory")
				|| ModConfig.LOSE_QUEST_BOOK_ON_DEATH) {
			return;
