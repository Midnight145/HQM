...
public class ReputationMarker implements Comparable<ReputationMarker> {
	...
	@Override
	public int compareTo(ReputationMarker o) { return ((Integer) value).compareTo(o.value); }

	public String getTitle() { return name + ": " + value; }

	public boolean isNeutral() { return neutral; }

	public void setNeutral(boolean neutral) { this.neutral = neutral; }

	public String getLabel() { return name + " (" + value + ")"; }
