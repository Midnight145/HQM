...
public class ModConfig {
	...
	private static void loadConfig() {
		...
		NO_HARDCORE_MESSAGE = config.get(CATEGORY_GENERAL, NO_HARDCORE_MESSAGE_KEY, NO_HARDCORE_MESSAGE_DEFAULT,
				NO_HARDCORE_MESSAGE_COMMENT).getBoolean(NO_HARDCORE_MESSAGE_DEFAULT);

		ALWAYS_USE_TIER_NAME_FOR_REWARD_TITLES = config
				.get(CATEGORY_GENERAL, ALWAYS_USE_TIER_NAME_FOR_REWARD_TITLES_KEY,
						ALWAYS_USE_TIER_NAME_FOR_REWARD_TITLES_DEFAULT, ALWAYS_USE_TIER_NAME_FOR_REWARD_TITLES_COMMENT)
				.getBoolean(ALWAYS_USE_TIER_NAME_FOR_REWARD_TITLES_DEFAULT);

		LOSE_QUEST_BOOK_ON_DEATH = config.get(CATEGORY_GENERAL, LOSE_QUEST_BOOK_ON_DEATH_KEY,
				LOSE_QUEST_BOOK_ON_DEATH_DEFAULT, LOSE_QUEST_BOOK_ON_DEATH_COMMENT)
