...
public class RepeatInfo {
	...
	public RepeatType getType() { return type; }

	public String getMessage(Quest quest, EntityPlayer player) { return type.getMessage(quest, player, days, hours); }

	public String getShortMessage() { return type.getShortMessage(days, hours); }
