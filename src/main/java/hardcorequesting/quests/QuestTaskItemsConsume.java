...
public class QuestTaskItemsConsume extends QuestTaskItems {
	...
	public void onUpdate(EntityPlayer player, DataReader dr) {
		if (increaseItems(player.inventory.mainInventory, (QuestDataTaskItems) getData(player),
	...
	@Override
	protected GuiEditMenuItem.Type getMenuTypeId() { return GuiEditMenuItem.Type.CONSUME_TASK; }

	public boolean allowManual() { return true; }
}
