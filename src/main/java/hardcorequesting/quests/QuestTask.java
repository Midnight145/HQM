...
public abstract class QuestTask {
	...
	public void updateId() { this.id = parent.nextTaskId++; }

	public void setId(int id) { this.id = id; }

	public boolean isCompleted(EntityPlayer player) { return getData(player).completed; }

	public boolean isCompleted(String playername) { return getData(playername).completed; }
	...
	public Class<? extends QuestDataTask> getDataType() { return QuestDataTask.class; }

	public void write(DataWriter dw, QuestDataTask task, boolean light) { dw.writeBoolean(task.completed); }
	...
	public QuestDataTask getData(EntityPlayer player) { return getData(QuestingData.getUserName(player)); }
	...
	public QuestDataTask validateData(QuestDataTask data) {
		if (data.getClass() != getDataType()) { return newQuestData(); }
	...
	public String getLangKeyDescription() { return description; }

	public String getDescription() { return Translator.translate(description); }

	public String getLangKeyLongDescription() { return longDescription; }

	public String getLongDescription() { return Translator.translate(longDescription); }
	...
	public static void completeQuest(Quest quest, String playerName) {
		...
		for (QuestTask questTask : quest.getTasks()) {
			if (!questTask.getData(playerName).completed) { return; }
		}
	...
	public Quest getParent() { return parent; }
	...
	public List<QuestTask> getRequirements() { return requirements; }

	public void addRequirement(QuestTask task) { requirements.add(task); }

	public void clearRequirements() { requirements.clear(); }
	...
	public void copyProgress(QuestDataTask own, QuestDataTask other) { own.completed = other.completed; }

	public void onDelete() { EventHandler.instance().remove(this); }

	public void register(EventHandler.Type... types) { EventHandler.instance().add(this, types); }

	// for these to be called one must register the task using the method above
