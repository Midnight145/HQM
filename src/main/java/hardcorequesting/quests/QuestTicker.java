...
public class QuestTicker {
	...
	public QuestTicker(boolean isClient) { FMLCommonHandler.instance().bus().register(this); }

	@SubscribeEvent
	public void tick(TickEvent.ServerTickEvent event) { tick(false); }

	@SubscribeEvent
	public void tick(TickEvent.ClientTickEvent event) { tick(true); }
