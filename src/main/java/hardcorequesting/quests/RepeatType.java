...
public enum RepeatType {
	NONE("none", false) {
		@Override
		public String getMessage(Quest quest, EntityPlayer player, int days, int hours) { return null; }
	},
	...
	private static String formatResetTime(Quest quest, EntityPlayer player, int days, int hours) {
		if (days == 0 && hours == 0) { return GuiColor.RED + Translator.translate("hqm.repeat.invalid"); }
	...
	public String getName() { return Translator.translate("hqm.repeat." + id + ".title"); }

	public String getDescription() { return Translator.translate("hqm.repeat." + id + ".desc"); }

	public boolean isUseTime() { return useTime; }
	...
	public String getShortMessage(int days, int hours) { return null; }
}
