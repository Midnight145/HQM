...
public class QuestTaskReputationTarget extends QuestTaskReputation {
	...
	@Override
	public void onOpenBook(EventHandler.BookOpeningEvent event) { checkReputation(event.getPlayer()); }

	@Override
	public void onReputationChange(EventHandler.ReputationEvent event) { checkReputation(event.getPlayer()); }
