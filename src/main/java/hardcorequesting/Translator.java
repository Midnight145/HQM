...
public class Translator {
	...
	public static String translate(String id) { return StatCollector.translateToLocal(id).replace("\\n", "\n"); }

	public static String translate(String id, Object... args) { return translate(false, id, args); }
