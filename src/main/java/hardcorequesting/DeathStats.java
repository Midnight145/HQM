...
public class DeathStats {
	...
	public static DeathStats getBest() { return clientBest; }

	public static DeathStats getTotal() { return clientTotal; }

	private String name;
	protected int[] deaths = new int[DeathType.values().length];

	public DeathStats(String name) { this.name = name; }

	public String getName() { return Translator.translate(name); }

	public String getDescription(int id) { return DeathType.values()[id].getName() + ": " + deaths[id]; }
	...
	public int getDeaths(int id) { return deaths[id]; }
	...
	private static class DeathComparator implements Comparator<DeathStats> {
		...
		private DeathComparator(int id) { this.id = id; }
	...
	public static DeathStats getDeathStats(String name) { return clientDeaths.get(name); }

	public static DeathStats[] getDeathStats() { return clientDeathList; }
	...
	private static class DeathStatsBest extends DeathStats {
		...
		@Override
		public String getDescription(int id) { return DeathType.values()[id].getName() + "\n\n" + messages[id]; }
	}
