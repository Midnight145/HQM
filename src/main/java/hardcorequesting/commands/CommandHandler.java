...
public class CommandHandler extends CommandBase {
	...
	public static void register(ISubCommand command) { commands.put(command.getCommandName(), command); }

	public static boolean commandExists(String name) { return commands.containsKey(name); }

	@Override
	public boolean canCommandSenderUseCommand(ICommandSender sender) { return true; }

	@Override
	public String getCommandName() { return "hqm"; }
	...
	@Override
	public String getCommandUsage(ICommandSender sender) { return "/" + getCommandName() + " help"; }
	...
	public void processCommand(ICommandSender sender, String[] args) {
		...
		if (command != null) {
			if (command.isVisible(sender) && (sender.canCommandSenderUseCommand(command.getPermissionLevel(),
	...
	public static boolean isCommandsAllowedOrOwner(GameProfile username) {
		return MinecraftServer.getServer().getConfigurationManager().func_152596_g(username)
				|| MinecraftServer.getServer().isSinglePlayer()
						&& MinecraftServer.getServer().getServerOwner().equals(username);
	}
	...
	public static ISubCommand getCommand(String commandName) { return commands.get(commandName); }
}
