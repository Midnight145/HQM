...
public abstract class GuiEditMenuExtended extends GuiEditMenu {
	...
	protected abstract class TextBoxNumber extends TextBoxGroup.TextBox {
		...
		@Override
		public void reloadText(GuiBase gui) { setTextAndCursor(gui, isVisible() ? String.valueOf(getValue()) : "0"); }
		...
		protected boolean isNegativeAllowed() { return false; }
	...
	public void draw(GuiBase gui, int mX, int mY) {
		...
		if (isArrowVisible()) {
			...
			gui.drawCenteredString(getArrowText(), ARROW_X_LEFT + ARROW_W, ARROW_Y, 0.7F,
					ARROW_X_RIGHT - (ARROW_X_LEFT + ARROW_W), ARROW_H, 0x404040);
			String description = getArrowDescription();
			if (description != null) {
				gui.drawString(gui.getLinesFromText(description, 0.7F, ARROW_X_RIGHT - ARROW_X_LEFT + ARROW_W),
						ARROW_X_LEFT, ARROW_DESCRIPTION_Y, 0.7F, 0x404040);
			}
		}
	...
	protected boolean isArrowVisible() { return ARROW_Y != -1; }
