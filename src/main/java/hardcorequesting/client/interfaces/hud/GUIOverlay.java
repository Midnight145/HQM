...
public class GUIOverlay extends Gui {
	...
	public void onRenderExperienceBar(RenderGameOverlayEvent event) {
		...
		// String s = " Lives: " +
		// QuestingData.getQuestingData(mc.thePlayer).getLives();
	...
	public int getLives() { return QuestingData.getQuestingData(mc.thePlayer.getGameProfile().getName()).getLives(); }
