...
public class TextBoxLogic {
	...
	protected void textChanged(GuiBase gui) { lines = gui.getLinesFromText(text, mult, width); }
	...
	protected boolean isCharacterValid(char c) { return ChatAllowedCharacters.isAllowedCharacter(c); }
