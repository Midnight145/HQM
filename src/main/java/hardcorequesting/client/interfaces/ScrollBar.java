...
public class ScrollBar {
	...
	public boolean isVisible(GuiBase gui) { return true; }
	...
	public void draw(GuiBase gui) {
		if (isVisible(gui)) {
			...
			gui.drawRect(x + 1, y + 1 + scroll, SCROLL_BAR_SRC_X, SCROLL_BAR_SRC_Y, SCROLL_BAR_WIDTH,
					SCROLL_BAR_HEIGHT);
		}
	}
	...
	public int getRawScroll() { return scroll; }

	public float getScroll() { return (float) scroll / (h - SCROLL_BAR_HEIGHT - 2); }
