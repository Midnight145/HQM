...
public class EditButton {
	...
	public void draw(int mX, int mY) {
		...
		guiQuestBook.drawRect(x + 2, y + 2,
				...
				BUTTON_ICON_SRC_Y + (mode.ordinal() / EDIT_BUTTONS_SRC_PER_ROW) * BUTTON_ICON_SIZE, BUTTON_ICON_SIZE,
				BUTTON_ICON_SIZE);
	}
	...
	public boolean click() { return onClick(x, y); }

	public boolean matchesMode(EditMode mode) { return this.mode == mode; }
}
