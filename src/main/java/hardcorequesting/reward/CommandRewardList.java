...
public class CommandRewardList extends QuestRewardList<CommandReward.Command> {
	...
	public void add(String command) { list.add(new CommandReward(new CommandReward.Command(command))); }

	public void set(int id, String command) { list.set(id, new CommandReward(new CommandReward.Command(command))); }
}
