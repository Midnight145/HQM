...
public class DataReader {
	...
	public int readByte() { return readData(DataBitHelper.BYTE); }

	public boolean readBoolean() { return readData(DataBitHelper.BOOLEAN) != 0; }

	public int readData(DataBitHelper bitCount) { return readData(bitCount.getBitCount(version)); }
	...
	public FileVersion readVersion() { return version = FileVersion.values()[readByte()]; }

	public ItemStack readItemStack(boolean useSize) { return readRawItemStack(false, useSize); }

	public ItemStack readAndFixItemStack(boolean useSize) { return readRawItemStack(true, useSize); }

	// fix is true if previous versions loaded it wrong here and therefore needs to
	// get fixed
