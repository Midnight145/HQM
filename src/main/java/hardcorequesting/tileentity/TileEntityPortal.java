...
public class TileEntityPortal extends TileEntity implements IBlockSync {
	...
	public boolean isCompletedTexture() { return completedTexture; }

	public void setCompletedTexture(boolean completedTexture) { this.completedTexture = completedTexture; }

	public boolean isUncompletedTexture() { return uncompletedTexture; }

	public void setUncompletedTexture(boolean uncompletedTexture) { this.uncompletedTexture = uncompletedTexture; }

	public boolean isCompletedCollision() { return completedCollision; }

	public void setCompletedCollision(boolean completedCollision) { this.completedCollision = completedCollision; }

	public boolean isUncompletedCollision() { return uncompletedCollision; }
	...
	private void keepClientDataUpdated() {
		...
		else if (!hasUpdatedData && distance < Math
				.pow(PacketHandler.BLOCK_UPDATE_RANGE - PacketHandler.BLOCK_UPDATE_BUFFER_DISTANCE, 2)) {
			hasUpdatedData = true;
	...
	public void openInterface(EntityPlayer player) { PacketHandler.sendBlockPacket(this, player, 1); }

	@SideOnly(Side.CLIENT)
	public void sendToServer() { PacketHandler.sendBlockPacket(this, Minecraft.getMinecraft().thePlayer, 1); }

	@Override
	public int infoBitLength() { return 1; }
