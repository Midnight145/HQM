...
public class EventHandler {
	...
	public static EventHandler instance() { return instance; }
	...
	private List<QuestTask> getTasks(Type type) { return registeredTasks[type.ordinal()]; }
	...
	public static class BookOpeningEvent {
		...
		public boolean isOpBook() { return isOpBook; }

		public boolean isRealName() { return isRealName; }

		public EntityPlayer getPlayer() { return QuestingData.getPlayer(playerName); }
	}

	public static class ReputationEvent {
		private EntityPlayer player;

		public ReputationEvent(EntityPlayer player) { this.player = player; }

		public EntityPlayer getPlayer() { return player; }
	}

	public enum Type {
		SERVER, PLAYER, DEATH, CRAFTING, PICK_UP, OPEN_BOOK, REPUTATION_CHANGE,
	}
