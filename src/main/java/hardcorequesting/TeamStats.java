...
public class TeamStats {
	...
	private static class TeamComparator implements Comparator<TeamStats> {
		...
		@Override
		public int compare(TeamStats o1, TeamStats o2) { return ((Integer) o2.progress).compareTo(o1.progress); }
	}
	...
	public static TeamStats[] getTeamStats() { return clientTeamsList; }
}
