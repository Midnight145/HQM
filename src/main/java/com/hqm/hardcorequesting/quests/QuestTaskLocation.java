...
import com.hqm.hardcorequesting.client.interfaces.GuiEditMenuLocation;
            ...
            if (!world.isRemote) {
                ...
                for (int i = 0; i < locations.length; ++i) {
                    ...
                    if (!visited[i] && player.worldObj.provider.dimensionId == location.dimension) {
                        int current = (int) player
                            .getDistanceSq(location.x + 0.5D, location.y + 0.5D, location.z + 0.5D);
